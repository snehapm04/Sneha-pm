...
export default function Projects({ theme, textVariants, fullPage = false }) {
  ...
  const projects = [
...

    {
      ...
      description:
        "Predicts telecom customer churn using ML and emotional analysis",
...

    {
      ...
      description:
        "Deep learning LSTM network for sequence based text prediction",
      image: "/next-word.jpg",
    ...
    },
    {
      ...
      description:
        "ML-based healthcare prediction system for Heart Disease, Parkinson’s, and Diabetes with real-time predictions.",
      image: "/disease.jpg",
...

    {
      ...
      description:
        "AI based synthetic dataset generation using statistical modeling",
    ...
    },
    {
      ...
      description:
        "Multi-agent system that generates comprehensive marketing campaigns using AI agents powered by CrewAI and AutoGen",
      image: "/market.jpg",
    ...
    },
    {
      ...
      description:
        "A Tkinter-based desktop application that connects to a MySQL database to manage blood donor information.",
      image: "/blood.jpg",
    ...
    },
    {
      ...
      description:
        "Implementation of a GUI-based banking system using Python's Tkinter library",
      image: "/banking.jpg",
    ...
    },
    {
      ...
      description:
        "Web-based application for users learn vocabulary through interactive flashcards.",
      image: "/flashcard.jpg",
